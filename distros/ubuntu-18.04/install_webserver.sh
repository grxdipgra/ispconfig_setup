...
InstallWebServer() {
  ...
  if [ "$CFG_WEBSERVER" == "apache" ]; then
	...
	apt-get -yqq   php7.2-curl php7.2-intl php7.2-pspell php7.2-recode php7.2-sqlite3 php7.2-tidy php7.2-xmlrpc php7.2-xsl php7.2-mcrypt mcrypt memcached php-memcache php-imagick php-gettext php7.2-zip php7.2-mbstring php-soap php7.2-soap > /dev/null 2>&1
	echo -e "[${green}HECHO${NC}]\n"
